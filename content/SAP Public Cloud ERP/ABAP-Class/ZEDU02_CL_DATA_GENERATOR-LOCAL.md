  ...
  PROTECTED SECTION.  
    TYPES:  
      BEGIN OF ts_location,  
        building     TYPE ZEDU02T005-building,  
        country      TYPE ZEDU02T005-country,  
        street       TYPE ZEDU02T005-street,  
        city         TYPE ZEDU02T005-city,  
        postcode     TYPE ZEDU02T005-postcode,  
        addresslabel TYPE ZEDU02T005-address_label,  
      END OF ts_location,  
      tt_location TYPE STANDARD TABLE OF ts_location WITH EMPTY KEY,  
  
      BEGIN OF ts_region,  
        region  TYPE ZEDU02T001-region,  
        country TYPE ZEDU02T001-country,  
      END OF ts_region,  
    ...
    CLASS-METHODS:  
      ...
      get_field_with_quantity  
        RETURNING  
          VALUE(rv_dec)             TYPE ZEDU02T001-field_with_quantity,  
      get_price  
        RETURNING  
          VALUE(rv_dec)             TYPE ZEDU02T001-field_with_price,  
      get_location  
        RETURNING  
      ...
      get_percent  
        RETURNING  
          VALUE(rv_percent)         TYPE ZEDU02T002-field_with_percent,  
      get_size  
        RETURNING  
          VALUE(rv_size)            TYPE ZEDU02T007-folder_size,  
      get_boolean  
        RETURNING  
...
CLASS lcl_fsa_contact DEFINITION CREATE PUBLIC INHERITING FROM lcl_abstract.  
  ...
  PUBLIC SECTION.  
    TYPES:  
     tt_contact TYPE STANDARD TABLE OF ZEDU02T005 WITH KEY id.  
    ...
    CLASS-METHODS:  
      ...
      get  
        RETURNING  
          VALUE(rs_contact) TYPE ZEDU02T005.  
  PROTECTED SECTION.  
  PRIVATE SECTION.  
    CLASS-DATA:  
...
CLASS lcl_fsa_criticality DEFINITION CREATE PUBLIC INHERITING FROM lcl_abstract.  
  ...
  PUBLIC SECTION.  
    TYPES:  
     tt_criticality TYPE STANDARD TABLE OF ZEDU02T006 WITH KEY code.  
    ...
    CLASS-METHODS:  
      ...
      get  
        RETURNING  
          VALUE(rs_criticality) TYPE ZEDU02T006.  
  PROTECTED SECTION.  
  PRIVATE SECTION.  
    CLASS-DATA:  
...
CLASS lcl_fsa_navigation DEFINITION CREATE PUBLIC INHERITING FROM lcl_abstract.  
  ...
  PUBLIC SECTION.  
    TYPES:  
     tt_navigation TYPE STANDARD TABLE OF ZEDU02T008 WITH KEY id.  
    ...
    CLASS-METHODS:  
      ...
      get  
        RETURNING  
          VALUE(rs_navigation) TYPE ZEDU02T008.  
  PROTECTED SECTION.  
  PRIVATE SECTION.  
    CLASS-DATA:  
...
CLASS lcl_fsa_root DEFINITION CREATE PUBLIC INHERITING FROM lcl_abstract.  
  ...
  PUBLIC SECTION.  
    TYPES:  
     tt_root TYPE STANDARD TABLE OF ZEDU02T001 WITH KEY id.  
...
CLASS lcl_fsa_chart DEFINITION CREATE PUBLIC INHERITING FROM lcl_abstract.  
  ...
  PUBLIC SECTION.  
    TYPES:  
     tt_chart TYPE STANDARD TABLE OF ZEDU02T004 WITH KEY id.  
...
CLASS lcl_fsa_child DEFINITION CREATE PUBLIC INHERITING FROM lcl_abstract.  
  ...
  PUBLIC SECTION.  
    TYPES:  
     tt_child TYPE STANDARD TABLE OF ZEDU02T002 WITH KEY id.  
...
CLASS lcl_fsa_grandchild DEFINITION CREATE PUBLIC INHERITING FROM lcl_abstract.  
  ...
  PUBLIC SECTION.  
    TYPES:  
     tt_grandchild TYPE STANDARD TABLE OF ZEDU02T003 WITH KEY id.  
...
CLASS lcl_fsa_folder DEFINITION CREATE PUBLIC INHERITING FROM lcl_abstract.  
  ...
  PUBLIC SECTION.  
    TYPES:  
     tt_folder TYPE STANDARD TABLE OF ZEDU02T007 WITH KEY folder_id root_id.  
    ...
    CLASS-METHODS:  
      ...
      get  
        IMPORTING is_folder TYPE ZEDU02T007  
                  it_folder TYPE tt_folder  
        RETURNING  
          VALUE(rs_folder) TYPE ZEDU02T007.  
  PROTECTED SECTION.  
  PRIVATE SECTION.  
    CLASS-DATA:  
